...
<CardGrid>
  ...
  <Card title="Methodology Perspective" icon="pencil">
...
2. **SWE-bench 5% → 79%**: Agent capability has improved substantially in three years. The core problem is control, not capability alone.
...
6. **The 15-week arc**: Governance → Infrastructure → Loops → Multi-agent → MLOps → Ralphthon. This course builds an agentic SDLC pipeline step by step.
...
- [NIST AI Risk Management Framework](https://www.nist.gov/artificial-intelligence) — AI system risk management
