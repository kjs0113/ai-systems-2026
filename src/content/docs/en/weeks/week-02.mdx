...
<CardGrid>
  <Card title="Design Perspective" icon="setting">
  ...
  <Card title="Regulatory Perspective" icon="seti:lock">
  ...
  <Card title="Incident Analysis Perspective" icon="warning">
...
- [Pillar Security: Rules File Backdoor](https://www.pillar.security/blog) — Detailed analysis of the Copilot/Cursor config file attack
...
- [NIST AI RMF Playbook](https://airc.nist.gov/Home) — Management framework implementation guide
