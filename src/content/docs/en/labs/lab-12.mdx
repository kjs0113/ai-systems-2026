...
<Aside type="caution" title="A Judge Is Not a Test">
An LLM Judge is a probabilistic evaluator. Use it only as a quality-assistance layer after deterministic gates (`pytest`, schema validation, policy checks) have passed.
</Aside>
